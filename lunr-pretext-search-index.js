...
},
{
  ...
  "level": "1",
  "url": "intro-graph-theory.html",
  "type": "Section",
  "number": "7.1",
  "title": "Introduction to Graph Theory",
  "body": " Introduction to Graph Theory  Applications of graphs include:   Social interaction    Influence    Call network    World wide web    Citation graph    Collaboration    PageRank         The set of edges is a set whose elements are subsets of two vertices. Vertices can also be called nodes. Let the set of Vertices and the set of edges be defined as follows:     A multigraph is a graph with multiple edges between the same pair of vertices. Keep in mind that these definitions are not standardized and may vary from source to source. Be sure to set multiedges=True for a multigraph in Sage.   "
},
{
  "id": "intro-graph-theory-6",
  "level": "2",
  "url": "intro-graph-theory.html#intro-graph-theory-6",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "multigraph "
